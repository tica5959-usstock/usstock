...
class SectorHeatmapCollector:
    ...
    def __init__(self):
        ...
        self.sector_stocks = {
             ...
             'Consumer Disc.': ['AMZN', 'TSLA', 'HD', 'MCD', 'NKE', 'LOW', 'SBUX', 'TJX'],
             'Consumer Staples': ['PG', 'KO', 'PEP', 'COST', 'WMT', 'PM', 'MDLZ', 'CL'],
             'Industrials': ['CAT', 'BA', 'HON', 'UNP', 'RTX', 'LMT', 'DE', 'GE'],
             'Materials': ['LIN', 'APD', 'SHW', 'FCX', 'NEM', 'ECL', 'DD', 'DOW'],
             'Utilities': ['NEE', 'SO', 'DUK', 'D', 'AEP', 'EXC', 'SRE', 'XEL'],
             'Real Estate': ['PLD', 'AMT', 'CCI', 'EQIX', 'PSA', 'SPG', 'WELL', 'O'],
             'Comm. Services': ['GOOGL', 'META', 'DIS', 'NFLX', 'CMCSA', 'T', 'VZ', 'TMUS']
        }
